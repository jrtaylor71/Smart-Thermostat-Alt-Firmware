...
static bool getMD5(uint8_t * data, uint16_t len, char * output){//33 bytes or more
  ...
  mbedtls_md5_starts(&_ctx); // Use mbedtls_md5_starts instead of mbedtls_md5_starts_ret
  mbedtls_md5_update(&_ctx, data, len); // Use mbedtls_md5_update instead of mbedtls_md5_update_ret
  mbedtls_md5_finish(&_ctx, _buf); // Use mbedtls_md5_finish instead of mbedtls_md5_finish_ret
#else
  MD5Init(&_ctx);
